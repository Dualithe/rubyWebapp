...
class LibrariansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create librarian" do
    assert_difference("Librarian.count") do
      post librarians_url, params: { librarian: { hire_date: @librarian.hire_date, librarian_id: @librarian.librarian_id } }
    end
  ...
  test "should update librarian" do
    patch librarian_url(@librarian), params: { librarian: { hire_date: @librarian.hire_date, librarian_id: @librarian.librarian_id } }
