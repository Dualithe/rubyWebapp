class BookCopiesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @book_copy.save
        format.html { redirect_to book_copy_url(@book_copy), notice: "Book copy was successfully created." }
  ...
  def update
    respond_to do |format|
      if @book_copy.update(book_copy_params)
        format.html { redirect_to book_copy_url(@book_copy), notice: "Book copy was successfully updated." }
  ...
  private
    ...
    def book_copy_params
      params.require(:book_copy).permit(:book_id, :copy_id)
    end
end
